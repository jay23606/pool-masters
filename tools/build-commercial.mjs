...
['Rule variants beyond 8/9-ball',['y','n','p','y','y','y'],'Ours: bank pool and one-pocket. Virtual Pool 4 lists 27 games; Cue Club 2 lists 6, 7, 10-ball, 14.1, speed pool and killer; Pure Pool has challenge games.'],
['Straight pool (14.1)',['n','n','u','y','y','y']],
['Snooker or carom billiards',['n','n','u','y','y','y']],
['Party or arcade modes (killer, speed pot, rumble)',['n','u','y','u','y','y'],'Pure Pool: Speed Pot, Checkpoint, Perfect Potter, Royal Rumble.'],
['Customisable rules',['n','u','u','u','y','u'],'Cue Club 2 lists "fully customisable rules".'],
...
const items=[
 ...
 {rank:4,title:'More rule sets: 10-ball and straight pool',tag:['med','Medium impact'],
  body:'Virtual Pool 4, Cue Club 2 and Real Pool 3D list straight pool (14.1); Cue Club 2 also has 10-ball. Ten-ball is nine-ball with one more ball and called shots, so it is a small change to the rules module; straight pool (call every shot, re-rack at one ball) is larger but still pure rules. Killer needs three or more players.',
  who:'Virtual Pool 4, Cue Club 2, Real Pool 3D'},
 {rank:5,title:'House rules',tag:['med','Medium impact'],
  body:'Cue Club 2 advertises fully customisable rules. We hard-code race-to-3, ball in hand, and called 8-ball pockets. Letting a table host switch those (race length, ball in hand or not, call every shot, break rule) fits the existing table settings, and pure rules functions can take the options as arguments.',
  who:'Cue Club 2'},
