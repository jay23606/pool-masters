...
function paintReplayBar(r){$('#replay-bar').hidden=!r}
...
async function openReplay(link){
 ...
 showGame()
 $('#game').classList.add('focus');$('.call-actions').hidden=true;$('#room-sidebar').hidden=true;$('.shot-controls').hidden=true
